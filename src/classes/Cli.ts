...
class Cli {
  ...
  findVehicleToTow(towingTruck: Truck): void {
    inquirer
      .prompt([
        {
          type: 'list',
      ...
      .then((answers) => {
        if (answers.vehicleToTow instanceof Truck) {
          ...
          if (towingTruck.towingCapacity >= answers.vehicleToTow.weight) {
            towingTruck.tow(answers.vehicleToTow);
          } else {
            console.log(
              'The selected vehicle is too heavy to be towed by this truck',
            );
          }
          this.performActions();
        }
      ...
      .then((answers) => {
        if (answers.action === 'Print details') {
          ...
          this.findVehicleToTow(
            this.vehicles.find(
              (vehicle: Car | Truck | Motorbike): boolean =>
